...
class Main:
    while True:
        ...
        match var:
            ...
            case 4:
                book1 = Book("Бліндаж", "Васіль Быкаў", 1987, 274)
                book1.info()

                v_year = 2024
                print(f"{v_year} год з'яўляецца весакосным") if Book.is_leap_year(2024) else print(
                    f"{v_year} год не з'яўляецца весакосным")

                book2 = Book.from_string("Вядзьмак, Геральд, 2077, 203")
                book2.info()